            ...
            <Container style='flex-col lg:flex-row pt-10 lg:pt-[72px] pb-[72px] justify-between gap-6 '>
                ...
                <div className=" flex flex-col gap-5 lg:max-w-[380px] bottom-anim">
                    ...
                    <div className="flex  gap-6 pt-4">
                        <a href="https://www.upwork.com/freelancers/~01a687c8f95b7913d7" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-facebook w-6 h-6 hover:scale-125 duration-300">
                            <FacebookIcon />
                        </a>
                        <a href="https://www.upwork.com/freelancers/~01a687c8f95b7913d7" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-instagram w-6 h-6 hover:scale-125 duration-300">
                            <InstagramIcon />
                        </a>
                        <a href="https://www.upwork.com/freelancers/~01a687c8f95b7913d7" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="hover:text-red w-6 h-6 hover:scale-125 duration-300">
                            <YouTubeIcon />
                        </a>
                        <a href="https://www.upwork.com/freelancers/~01a687c8f95b7913d7" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:text-twitter w-6 h-6 hover:scale-125 duration-300">
                            <TwitterIcon />
                        </a>
                    </div>
                </div>
